...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="bg-accent-background text-zinc-700 dark:text-zinc-300">
    <head>
        ...
        <link rel="icon" type="image/svg+xml" href="{{ asset('vendor/eseances/favicon.svg') }}" />
        <link rel="mask-icon" href="{{ asset('vendor/eseances/favicon.svg') }}" color="#010D7D" />
        <link rel="apple-touch-icon" href="{{ asset('vendor/eseances/favicon.svg') }}" />
        ...
        <meta property="og:image" content="{{ asset('/vendor/eseances/favicon.svg') }}" />
        ...
        <meta property="twitter:image" content="{{ asset('/vendor/eseances/favicon.svg') }}" />
